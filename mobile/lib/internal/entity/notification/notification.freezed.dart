...
class _$_Notification implements _Notification {
  const _$_Notification(this.title, this.message,
  ...
  @override
  String toString() {
    return 'Notification(title: $title, message: $message, createdDate: $createdDate)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, message, createdDate);
...
abstract class _Notification implements Notification {
  const factory _Notification(final String title, final String message,
...
mixin _$NotificationList {
  List<Notification>? get messageList => throw _privateConstructorUsedError;
...
abstract class $NotificationListCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Notification>? messageList});
}
...
class _$_NotificationList implements _NotificationList {
  const _$_NotificationList(final List<Notification>? messageList)
      : _messageList = messageList;

  factory _$_NotificationList.fromJson(Map<String, dynamic> json) =>
      _$$_NotificationListFromJson(json);

  final List<Notification>? _messageList;
  @override
  List<Notification>? get messageList {
  ...
  @override
  String toString() {
    return 'NotificationList(messageList: $messageList)';
  }
...
abstract class _NotificationList implements NotificationList {
  const factory _NotificationList(final List<Notification>? messageList) =
      _$_NotificationList;
